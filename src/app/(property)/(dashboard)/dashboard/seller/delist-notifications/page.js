...
const DelistNotifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await ApiFetchRequest("/delist/notifications");
        ...
        <div className="row align-items-center pb40">
          <div className="col-lg-12">
            <div className="dashboard_title_area">
              ...
              <p className="text">View updates on your delist requests</p>
            </div>
          </div>
        </div>
                      ...
                      >
                        <div className="d-flex justify-content-between align-items-start mb-3">
                          <h4 className="font-semibold text-dark mb-0">
                            {notification.property_name || notification.propertyId?.title || 'Unknown Property'}
                          </h4>
                          <span
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              ...
                              <p className="mb-2">
                                ...
                                <span className={`delist-status-badge ms-2 ${
                                  (notification.request_type || 'seller') === "seller" 
                            ...
                            <div className="col-md-6">
                              {notification.processed_by && (
                                <p className="mb-2">
                                  <strong className="text-dark">Processed by:</strong> {notification.processed_by.fullname || 'Unknown'}
                                </p>
                              )}
                            </div>
                          </div>
...
export default DelistNotifications;
