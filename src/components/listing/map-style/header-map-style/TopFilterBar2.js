  ...
  return (
    <>
      ...
      <li className="list-inline-item position-relative">
        ...
        >
          {filterFunctions?.listingStatus === "All" ? "All Properties" : 
           filterFunctions?.listingStatus === "Buy" ? "For Sale" :
           filterFunctions?.listingStatus === "Rent" ? "For Rent" :
           filterFunctions?.listingStatus === "Commercial" ? "Commercial" :
           "All Properties"} <i className="fa fa-angle-down ms-2" />
        </button>
